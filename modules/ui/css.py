...
def inject_css():
    st.markdown("""
<style>
/* ── ZERO ANIMATIONS & TRANSITIONS FOR INSTANT INTERACTION ─────────────── */
*, *::before, *::after {
...
.kpi-val  { font-family: var(--font-brand); font-size: 1.65rem; font-weight: 800; line-height: 1.1; color: var(--text-primary); }
.kpi-lbl  { font-size: .65rem; text-transform: uppercase; letter-spacing: .1em; font-weight: 700; color: var(--text-muted); margin-top: .25rem; }

/* ── ANALYSIS GRID CARDS ──────────────────────────────────────────────── */
.ag-card  { padding: .9rem .75rem; text-align: center; min-height: 96px;
    display: flex; flex-direction: column; align-items: center; justify-content: center; }
.ag-card.done { border-color: var(--brand-1) !important; box-shadow: 0 0 0 2px rgba(79,110,247,.22) !important; }
...
.done-badge { font-size: .63rem; background: var(--success); color: #fff; padding: .1rem .5rem; border-radius: 20px; margin-top: .35rem; font-weight: 600; }
...
.sec-label { font-size: .68rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: var(--text-muted); margin: 1.4rem 0 .7rem; }
.pill { display: inline-block; background: rgba(255,255,255,.18); border: 1px solid rgba(255,255,255,.28); border-radius: 20px; padding: .26rem .8rem; font-size: .78rem; margin: .2rem; color: #fff; }
...
label, .stTextInput label, .stSelectbox label, .stTextArea label {
    font-size: .8rem !important; font-weight: 600 !important; color: var(--text-secondary) !important; letter-spacing: .01em !important;
}
...
.stTabs [data-baseweb="tab-list"] {
    ...
    border-radius: var(--radius-lg) !important; padding: .35rem !important;
    border: 1px solid var(--border-soft) !important;
}
...
.stTabs [aria-selected="true"] {
    background: linear-gradient(135deg, var(--brand-1), var(--brand-2)) !important;
    color: #fff !important; box-shadow: var(--shadow-brand) !important;
}

/* ── ALERTS & TOAST ───────────────────────────────────────────────────── */
.stAlert { border-radius: var(--radius-md) !important; border: none !important; backdrop-filter: blur(8px) !important; }
...
def render_logo():
    ...
    st.markdown(
        f'<a href="{home_url}" target="_self" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;">'
...
def render_page_steps(current: str):
    ...
    st.markdown(f'<div class="ly-steps">{"".join(parts)}</div>', unsafe_allow_html=True)
...
.ft-social-btn{display:inline-flex;align-items:center;gap:5px;padding:4px 11px;border-radius:8px;font-size:12px;font-weight:500;text-decoration:none;}
.ft-col-title{font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;margin-bottom:11px;}
.ft-link{display:block;font-size:12.5px;text-decoration:none;margin-bottom:7px;}
