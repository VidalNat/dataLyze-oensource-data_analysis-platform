...
def inject_footer():
    ...
    # logo_data_uri() reads assets/lytrize.ico and returns a base64 data URI.
    # We use a __LYTRIZE_LOGO__ placeholder rather than an f-string because
    # the footer HTML contains CSS curly braces {} which break f-string parsing.
...
<div class="ft">
  <div class="ft-grid">
    ...
    <div>
      ...
      <a class="ft-link" href="https://github.com/VidalNat/dataLyze/wiki/Contributing-guide" target="_blank">Contributor Guide</a>
    ...
    <div>
      ...
      <a class="ft-link" href="https://github.com/VidalNat/dataLyze/discussions/categories/q-a" target="_blank">Get Support</a>
